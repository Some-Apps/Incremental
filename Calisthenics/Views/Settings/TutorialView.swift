    ...
    var body: some View {
        ScrollView {
            VStack(spacing: 50) {
                ...
                TutorialItem(title: "Stashed Tab", description: "This is where exercises go when you tap \"Stash Exercise\". You can complete them just as you would in the \"Exercise\" tab.")
                ...
                TutorialItem(title: "Settings Tab", description: "Here you can determine how your exercise reps/durations are incremented based on difficulty. You can also change the maximum amount of stashed exercises you can have at one time. These settings are locked unless you tap \"Enable Changes\"")
