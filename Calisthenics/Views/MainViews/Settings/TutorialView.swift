    ...
    var body: some View {
        ScrollView {
            VStack(spacing: 50) {
                ...
                TutorialItem(title: "Stashed Tab", description: "This is where exercises go when you tap \"Stash Exercise\". You can complete them just as you would in the \"Exercise\" tab. You can have a maximum of 15 stashed exercises at a time.")
